...
* [#13859](https://dev.ckeditor.com/ticket/13859): QiniuyunTest cases created with `bender.tools.createTestsForEditors` will also receive editor bot as a second parameter.
